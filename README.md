...
- To download the built files for a given release tag (example `1.2.3`), use the Releases download URL:

  `https://github.com/AR-js-org/arjs-plugin-artoolkit/releases/download/1.2.3/dist/arjs-plugin-artoolkit.es.js`
